...
def train_and_validate(parameterization, x_e, x_m, x_c, y, device, pin_memory):
    ...
    h_dim4 = parameterization['h_dim4'] if 'h_dim4' in parameterization else None
    ...
    depth_4 = parameterization['depth_4'] if 'depth_4' in parameterization else None
    depth_5 = parameterization['depth_5']
    lr_e = parameterization['lr_e']
    lr_m = parameterization['lr_m']
    lr_c = parameterization['lr_c']
    lr_middle = parameterization['lr_middle'] if 'lr_middle' in parameterization else None
