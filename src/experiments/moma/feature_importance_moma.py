...
def moma_feature_importance(
    ...
    train_predictions = moma_model(gdsc_e_scaled, gdsc_m, gdsc_c)
    ...
    integradet_gradients = KernelShap(full_moma_model)
    ...
    extern_predictions = moma_model(extern_e_scaled, extern_m, extern_c)
